...
| Action | Risk |
|---|---|
| Auto-submit a generated reply without editing | Shadowban or permanent ban |
| Post the exact same reply in multiple threads | Spam detection triggers immediately |
| Generate 50+ replies per hour | Rate-limit flag + account review |
| Use on brand-new accounts at high volume | Account age + karma are factors in detection |
...
| Practice | Why |
|---|---|
| Edit at least 1-2 words before posting | Makes it uniquely yours |
| Vary reply length across threads | Identical structure = pattern detection |
| Take natural breaks (don't post every 2 minutes) | Human posting cadence matters |
| Match subreddit culture and rules | Each subreddit has unique tone expectations |
| Upvote and engage normally alongside replies | Pure reply-only accounts look suspicious |
...
- Support communities (mental health, etc.)
- AMA threads

Communities that tend to be more relaxed about AI assistance:
- Tech and programming subs
...
Generated content must comply with [OpenAI's usage policies](https://openai.com/policies/usage-policies). Do not use RedPilot to generate:

- Harassment or targeted attacks
- Misinformation or propaganda
- Content that violates a subreddit's rules intentionally
...
- In severe cases, you may need a new account
